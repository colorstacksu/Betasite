    ...
    <Container className="mt-5" >
      ...
      {rows.map((row, rowIndex, team) => (
        <Row 
          key={rowIndex} 
          className="mb-4"
          style={{borderRadius:'30px' ,backgroundColor: rowIndex % 2 === 0 ? '#b2f0e' : '#fff' }}
        >
          <div  style={{ display: 'flex', justifyContent: 'center' }}><Col md={4}><h4 className='eboard-custom-h1'>{teams[rowIndex]}</h4></Col></div>
              ...
              <Card style={{marginTop:'2%', borderRadius:'30px',height:'97%',alignItems:'center'}}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    {member.name}<br/>
                    {member.description}
                    <Row style={{padding:'0.5rem'}}><a href={member.linkedIn} target='_blank'>
                <FaLinkedin size={30} />
              </a></Row>
                  </Card.Text>
                </Card.Body>
