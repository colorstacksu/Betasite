  ...
  return (
    <Col md={4} className="d-flex align-items-center">
      <div style={{ padding: '10px', color: 'black' }}>
        <h1 className="custom-h1" style={{ fontSize }}>Welcome to ColorStack KSU!</h1>
        <p style={{ fontSize: paraFontSize }}>ColorStack at Kennesaw State University</p>
        <Button style={{marginRight:"5px"}} href="https://app.colorstack.io/apply" variant="outline-warning">Join the National Org.</Button>
        <Button style={{marginLeft:"5px"}} href="https://owllife.kennesaw.edu/organization/colorstackksu" variant="outline-warning">Join Colorstack KSU</Button>
      </div>
    </Col>
  );
};
...
const MyComponent2 = () => {
  ...
  return (
    <Col md={4} className="d-flex align-items-center">
      <div style={{ padding: '10px', color: 'black' }}>
        <h1 className="custom-h1" style={{ fontSize }}>RSVP for our Latest Events Here!</h1>
        <p style={{ fontSize: paraFontSize }}>ColorStack at Kennesaw State University</p>
      </div>
    </Col>
  );
  ...
  <Col className="d-flex justify-content-end position-relative" md={8}>
    ...
    >
      ...
      style={{
        ...
        style={{ fontSize: "2vw" }}
        onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSepWziFmDtZJE4kr3u33wStPJLi9aryICe2U4X3XyGe-QU3fw/viewform', '_blank')}
      >
      ...
      {/* Second Button */}
        ...
        className="rsvpButton"
        style={{ fontSize: "2vw" }}
        onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSf5il9DFL0tApbIdG43HDt2e4mc_y1s0sakRbjzWCnPj9IIMg/viewform', '_blank')}
      >
      ...
      {/* Third Button */}
        ...
        className="rsvpButton"
        style={{ fontSize: "2vw" }}
        onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSeKRqPVA_j2Hz8yBEs6q53PiRJ-DcQYIDsUjIdwoneLm_du-Q/viewform', '_blank')}
      >
